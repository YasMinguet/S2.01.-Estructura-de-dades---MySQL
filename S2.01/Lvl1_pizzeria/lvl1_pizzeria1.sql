...
CREATE TABLE IF NOT EXISTS `pizzeria`.`pedidos` (
  ...
  PRIMARY KEY (`pedidos_id`, `tienda_tienda_id`, `clientes_clientes_id`),
...
CREATE TABLE IF NOT EXISTS `pizzeria`.`detalle_pedido` (
  ...
  PRIMARY KEY (`detalle_pedido_id`, `productos_productos_id`, `pedidos_pedidos_id`),
  INDEX `fk_detalle_pedido_productos1_idx` (`productos_productos_id` ASC) VISIBLE,
  INDEX `fk_detalle_pedido_pedidos1_idx` (`pedidos_pedidos_id` ASC) VISIBLE,
